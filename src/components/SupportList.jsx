    ...
    render() {
        return (
            <div class="card-box table-responsive">
                <h4 class="m-t-0 header-title"><b>Danh sách toàn thể doanh nghiệp</b></h4>
                <div class="row">
                    <div class="col-sm-6" >
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Hoàn thành</td>
                                <td>
                                    <button class="btn btn-default waves-effect m-b-5"> <i class="glyphicon glyphicon-eye-open"></i> <span>Xem</span>
                                    </button>
                                </td>
                            </tr>
                            <tr>
